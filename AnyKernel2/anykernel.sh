...
## AnyKernel setup
# EDIFY properties
kernel.string=Blue Bolt Kernel
do.devicecheck=0
do.initd=0
do.modules=1
do.cleanup=1
...
# init.bluebolt.rc
insert_line init.qcom.rc "init.bluebolt.rc" after "import init.qcom.power.rc" "import init.bluebolt.rc";
replace_line init.qcom.power.rc 'setprop sys.io.scheduler "bfq"' " ";
# end ramdisk changes
